...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.beginstart = start.clone()
        self.beginend = self.end.clone()
        self.count = 0
    ...
    def line_plus(self, other_line):
        ...
        newstart = Point(self.start.x + other_line.start.x, self.start.y +
                         other_line.start.y)
        newend = Point(self.end.x + other_line.end.x, self.end.y +
                       other_line.end.y)
    ...
    def midpoint(self):
        ...
        pointx = ((self.end.x - self.start.x)/2) + self.start.x
        pointy = ((self.end.y - self.start.y)/2) + self.start.y
    ...
    def reset(self):
        ...
        self.start = self.beginstart
        self.end = self.beginend
        return self
